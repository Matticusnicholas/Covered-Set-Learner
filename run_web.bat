...
title Neural Network Lottery Optimizer - Web Interface

echo.
echo ========================================
echo   Neural Network Lottery Optimizer
echo   WEB BROWSER VISUALIZATION
echo ========================================
echo.
...
python -c "import torch; import flask; import flask_socketio" >nul 2>&1
if errorlevel 1 (
    set NEEDS_INSTALL=1
)
